...
"""Verify that starting shillingcoin with -h works as expected."""
import subprocess
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start shillingcoin with -h for help text")
        ...
        self.log.info("Start shillingcoin with -version for version information")
