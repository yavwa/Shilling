...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s shillingcoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  shillingcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded shillingcoin transaction") + "\n" +
              "  shillingcoin-tx [options] -create [commands]   " + _("Create hex-encoded shillingcoin transaction") + "\n" +
              "\n";
