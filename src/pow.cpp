...
unsigned int static GetNextWorkRequiredKGW(const CBlockIndex* pindexLast, const CBlockHeader *pblock, const Consensus::Params& params)
{
	...
	int64_t				PastSecondsMin				= TimeDaySeconds * 6.133 * 0.1;
	int64_t				PastSecondsMax				= TimeDaySeconds * 6.133 * 2.8;
...
unsigned int GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader *pblock, const Consensus::Params& params)
{
    ...
    else if(pindexLast->nHeight+1 < Params().SwitchLyra2REv2_DGW()){
        // KGW
        return GetNextWorkRequiredKGW(pindexLast, pblock, params);
    }
    ...
    // Shillingcoin: This fixes an issue where a 51% attack can change difficulty at will.
